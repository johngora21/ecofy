...
import { Map, Leaf, CloudRain, BarChart, Check } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <section className="relative py-24 md:py-32 bg-gradient-to-b from-shamba-sand to-white overflow-hidden">
