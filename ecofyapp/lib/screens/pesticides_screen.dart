...
class _PesticidesScreenState extends State<PesticidesScreen> {
  String? _selectedPesticideType;
  String? _selectedLocation;
  String? _selectedRegion;
  String _searchQuery = '';
  
  final List<String> _pesticideTypes = ['Insecticides', 'Herbicides', 'Fungicides', 'Rodenticides', 'Molluscicides', 'Nematicides'];
  ...
  Widget _buildProductGrid() {
    List<Map<String, dynamic>> pesticidesData = [
      {
        'id': '1',
      ...
      },
      {
        ...
        'quantity': '1L',
        'image': '🦋',
        'description': 'Natural biological pest control solution',
        'seller': 'Kilimanjaro Bio',
        'rating': 4.6,
        'reviews': 52,
        'inStock': false,
        'isNew': true,
      ...
      },
      {
        ...
        'quantity': '500g',
        'image': '🐀',
        'description': 'Effective rodent control bait',
        'seller': 'Dodoma Pest Co.',
        'rating': 4.3,
        'reviews': 24,
        'inStock': true,
        'isNew': false,
    ...
    List<Map<String, dynamic>> filteredData = pesticidesData.where((product) {
      bool matchesSearch = _searchQuery.isEmpty || 
          product['name'].toString().toLowerCase().contains(_searchQuery.toLowerCase());
      bool matchesType = _selectedPesticideType == null || 
          product['name'].toString().toLowerCase().contains(_selectedPesticideType!.toLowerCase());
